...
enum class TLogApiValidatorCapabilityKind {
    Unknown = 0,
    ValidateContentPresence,
    ValidateContentShape,
    ValidateRequiredFields,
    ValidateDefaultFieldApplicability,
    ValidatePayloadTimestampShape,
    ProduceValidationIssues,
    ProduceValidationEvidence
};

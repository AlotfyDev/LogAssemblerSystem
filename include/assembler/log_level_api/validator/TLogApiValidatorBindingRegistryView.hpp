...
struct TLogApiValidatorBindingRegistryView final {
    std::vector<TLogApiValidatorBindingDescriptor> bindings{};

    [[nodiscard]] const TLogApiValidatorBindingDescriptor* FindByName(const std::string& name) const noexcept {

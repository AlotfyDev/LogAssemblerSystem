...
#include "assembler/log_level_api/timestamp_stabilizer/TLogApiTimestampValue.hpp"

namespace assembler::log_level_api::timestamp_stabilizer::clock_calibration {

struct TLogApiClockSample final {
    TLogApiClockSourceDescriptor source{};
    assembler::log_level_api::timestamp_stabilizer::TLogApiTimestampValue timestamp{};

    [[nodiscard]] bool IsReady() const noexcept {
        return source.IsResolved() && timestamp.IsPresent();
    }
};

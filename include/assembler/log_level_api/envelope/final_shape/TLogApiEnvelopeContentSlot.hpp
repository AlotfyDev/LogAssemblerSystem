...
/*
    ...
    It can carry both original content input reference and parsed content
    reference. Parsed content may be opaque/no-parse.
*/
struct TLogApiEnvelopeContentSlot final {
    assembler::log_level_api::content::TLogApiContentInputRef content{};
    assembler::log_level_api::content_parser::TLogApiParsedContentRef parsed_content{};

    [[nodiscard]] bool IsPresent() const noexcept {
        return content.IsPresent() && parsed_content.IsPresent();
    }
};

...
enum class TLogApiContentParserCapabilityKind {
    Unknown = 0,
    PreserveOpaquePayload,
    ProduceParsedContentRef,
    ProduceLevelFieldView,
    ProduceMessageFieldView,
    ProducePayloadTimestampView,
    ProduceSchemaSpecificFieldView,
    ReportParseIssues
};

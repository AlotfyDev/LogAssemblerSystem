...
struct TLogApiMt5CalendarUtilityParserView final {
    std::string parser_name{};
    std::string schema_name{};
    bool ready{false};

    [[nodiscard]] static TLogApiMt5CalendarUtilityParserView From(const TLogApiMt5CalendarUtilityParserProfile& profile) {
        TLogApiMt5CalendarUtilityParserView view{};

...
/*
 * File: TPolicyRealizationContractId.hpp
 ...
 *
 * File responsibility:
 *   TPolicyRealizationContractId defines stable identity for realization contracts. It is a value identifier only; it does not own the contract, invoke a target, or imply runtime readiness.
 */

struct TPolicyRealizationContractId final
{
    std::uint64_t value{0};

    [[nodiscard]] constexpr bool IsValid() const noexcept { return value != 0; }
    [[nodiscard]] constexpr explicit operator bool() const noexcept { return IsValid(); }
    [[nodiscard]] friend constexpr bool operator==(TPolicyRealizationContractId lhs, TPolicyRealizationContractId rhs) noexcept { return lhs.value == rhs.value; }
    [[nodiscard]] friend constexpr bool operator!=(TPolicyRealizationContractId lhs, TPolicyRealizationContractId rhs) noexcept { return !(lhs == rhs); }
    [[nodiscard]] friend constexpr bool operator<(TPolicyRealizationContractId lhs, TPolicyRealizationContractId rhs) noexcept { return lhs.value < rhs.value; }
};

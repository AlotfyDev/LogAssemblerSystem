...
#include "assembler/ecosystem_governance/policy_type_system/ecosystem_targets/material_circulation/TMaterialCirculationPolicyTargetDescriptor.hpp"
...
/*
 * File responsibility:
 *   TMaterialCirculationPolicyTargetCapabilityProfile binds a material
 *   circulation policy target descriptor to a declared capability set. It is a
 *   compatibility input and not a method surface, target instance, or runtime
 *   invocation path.
 */
struct TMaterialCirculationPolicyTargetCapabilityProfile final
{
    ...
    [[nodiscard]] static TMaterialCirculationPolicyTargetCapabilityProfile MakeDefault(
        TMaterialCirculationPolicyTargetDescriptor descriptor)
    {
        TMaterialCirculationPolicyTargetCapabilityProfile profile;
        ...
        auto add = [&](TPolicyTargetCapabilityKind kind) {
            ...
            descriptor.target_kind = target;
            descriptor.capability_id = TPolicyTargetCapabilityId{static_cast<TPolicyTargetCapabilityId::value_type>(kind) + 1000u};
            descriptor.strength = TPolicyTargetCapabilityStrength::required;
            descriptor.mutability = TPolicyTargetCapabilityMutability::read_only;
            descriptor.canonical_name = "material_circulation_capability";
            profile.capabilities.Add(descriptor);

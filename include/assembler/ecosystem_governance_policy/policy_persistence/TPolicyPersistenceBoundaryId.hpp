...
/*
 * File responsibility:
 *   Stable identifier for a policy persistence boundary. It names the boundary
 *   through which policy artifacts may later be persisted without representing
 *   the concrete storage location or implementation.
 */
struct TPolicyPersistenceBoundaryId final
{
    std::string value{};

    constexpr bool empty() const noexcept { return false; }
    friend bool operator==(const TPolicyPersistenceBoundaryId& a, const TPolicyPersistenceBoundaryId& b) noexcept
    {

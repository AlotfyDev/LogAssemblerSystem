...
/*
 * File responsibility:
 *   Stable identifier for an audit export boundary. It identifies the boundary
 *   contract or adapter-facing surface, not an exporter instance and not a sink.
 */
struct TPolicyAuditExportBoundaryId final
{
    std::string value{};

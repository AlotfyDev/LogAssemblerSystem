...
#include "assembler/ecosystem_governance/policy_audit_export/TPolicyAuditExportBoundaryId.hpp"
#include "assembler/ecosystem_governance/policy_audit_export/TPolicyAuditExportMediumKind.hpp"
#include <string>
...
/*
 * File responsibility:
 *   Describes an audit export boundary and its governance-facing expectations:
 *   medium kind, owner domain, retention hint, authority requirement, and whether
 *   trace/evidence references are mandatory. It does not implement export.
 */
struct TPolicyAuditExportBoundaryDescriptor final
{
    TPolicyAuditExportBoundaryId boundary_id{};
    TPolicyAuditExportMediumKind medium_kind{TPolicyAuditExportMediumKind::unspecified};
    std::string owner_domain{};
    std::string retention_class{};
    bool requires_authority_evidence{true};
    bool requires_trace_reference{true};
    bool requires_record_reference{true};

    bool valid() const noexcept
    {
        return static_cast<bool>(boundary_id) && medium_kind != TPolicyAuditExportMediumKind::unspecified;
    }
};

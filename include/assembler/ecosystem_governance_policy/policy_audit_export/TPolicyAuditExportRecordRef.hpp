...
/*
 * File responsibility:
 *   Reference to an audit-exportable governance record. This is a reference
 *   carrier only; it does not fetch, serialize, persist, or export the record.
 */
struct TPolicyAuditExportRecordRef final
{

#pragma once
/*
    circulation_mechanism_waiting_list.hpp
    Compatibility/production aggregate for waiting-list component in PreBridge W03.
*/
#include "waiting_list/TWaitingListState.hpp"
#include "waiting_list/TWaitingListAdmissionStatus.hpp"

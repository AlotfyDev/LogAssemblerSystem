...
namespace circulation_mechanism {
    ...
    struct TModeratorId final
    {
        ...
        constexpr explicit TModeratorId(value_type input_value) noexcept : value(input_value) {}
        ...
        [[nodiscard]] friend constexpr bool operator==(TModeratorId lhs, TModeratorId rhs) noexcept
        {

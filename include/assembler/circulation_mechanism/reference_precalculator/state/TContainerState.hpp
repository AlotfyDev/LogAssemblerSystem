...
[[nodiscard]] constexpr bool ingress_reference_candidate(TContainerState s) noexcept {
    return s == TContainerState::default_empty || s == TContainerState::ingress_ready || s == TContainerState::ingress_round_member || s == TContainerState::receiving;
}
[[nodiscard]] constexpr bool dispatch_reference_candidate(TContainerState s) noexcept {

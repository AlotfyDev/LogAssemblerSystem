...
struct TDispatchAccessRef final {
    TSlotAccessRef base{};
    [[nodiscard]] constexpr bool is_valid() const noexcept { return base.is_valid() && base.kind == TAccessRefKind::dispatch_access && base.direction == TAccessRefDirection::dispatch; }
